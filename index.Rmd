...
The task was to take the flight dataset and make some value for the stakeholders.

I, Max Spehlmann, worked with a team of 4 Master's students, Zane Potorti, Salem Wear, Teresa Meng, and Rena Marrotta.
<br>
<br>
<br>
...
Finally we were ready to build our model.
...
finalGLM <- glm(probCarrierDelay ~ DayOfWeek + NO.SEATS + Month + Operating_Airline +
                  ...
                  I(sqrt(LateAircraftDelay)) + minutesSinceLastFlight*prevCarrierDelay + NO.SEATS*Origin, data=train_data,
...
#save(finalGLM, file='finalGLM.RData')
